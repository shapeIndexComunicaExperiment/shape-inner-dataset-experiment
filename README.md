# Shape Index Solidbench Experiment with Comunica where the shapes contain only information contained in the datasets

Experiments to benchmark solidbench queries using the shape index approach, where the shapes contained only information about the dataset.
